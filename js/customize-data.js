...
const SERVICE_PARAMS = {
    ...
    "homepage-design": [
        ...
        { key: "animation", type: "toggle", label: { el: "Micro-animations / Interactions", en: "Micro-animations / Interactions" }, price: 125 }
    ],
    ...
    "basic-logo": [
        ...
        { key: "socialkit", type: "toggle", label: { el: "Social Media Kit", en: "Social Media Kit" }, price: 85 }
    ],
    ...
    "plus-brand": [
        ...
        { key: "stationery", type: "toggle", label: { el: "Σχεδιασμός Stationery (κάρτες κ.λπ.)", en: "Stationery Design (cards, etc.)" }, price: 125 }
    ],
    ...
    "full-brand": [
        ...
        { key: "customgraphics", type: "toggle", label: { el: "Custom Graphics / Illustrations", en: "Custom Graphics / Illustrations" }, price: 215 }
    ],
    ...
    "extra-concepts": [
        ...
        { key: "rush", type: "toggle", scope: "flat", label: { el: "Rush Delivery", en: "Rush Delivery" }, price: 50 }
    ],
    ...
    "responsive-theme": [
        ...
        { key: "complexity", type: "select", label: { el: "Επίπεδο Λειτουργιών", en: "Feature Complexity" }, options: [
            ...
            { label: { el: "Προχωρημένη", en: "Advanced" }, price: 430, note: { el: "Dynamic filters, integrations, custom λειτουργίες", en: "Dynamic filters, integrations, custom functions" } }
        ]}
    ],
    ...
    "full-custom-website": [
        ...
        { key: "complexity", type: "select", label: { el: "Πολυπλοκότητα Custom Λειτουργιών", en: "Custom Feature Complexity" }, options: [
            ...
            { label: { el: "Προχωρημένη", en: "Advanced" }, price: 645, note: { el: "Dynamic λειτουργίες, integrations, dashboards", en: "Dynamic functions, integrations, dashboards" } },
    ...
    "full-package": [
        ...
        { key: "customgraphics", type: "toggle", label: { el: "Custom Illustrations / Graphics", en: "Custom Illustrations / Graphics" }, price: 375 }
    ],
    ...
    "ai-responsive-website": [
        ...
        { key: "chatbot", type: "toggle", label: { el: "AI Chatbot Integration", en: "AI Chatbot Integration" }, price: 215 }
    ],

    "ai-static-website": [
        { key: "pages", type: "stepper", label: { el: "Αριθμός Σελίδων", en: "Number of Pages" }, min: 1, max: 10, default: 4, baseline: 4, pricePerUnit: 84 },
        { key: "seo", type: "toggle", label: { el: "Επιπλέον SEO Optimization", en: "Extra SEO Optimization" }, price: 105 }
    ],

    "ai-static-template": [
        { key: "pages", type: "stepper", label: { el: "Αριθμός Σελίδων", en: "Number of Pages" }, min: 1, max: 10, default: 3, baseline: 3, pricePerUnit: 60 },
        { key: "seo", type: "toggle", label: { el: "Επιπλέον SEO Optimization", en: "Extra SEO Optimization" }, price: 85 }
    ],
    ...
    "shopify-theme": [
        ...
        { key: "payment", type: "toggle", label: { el: "Επιπλέον Payment Gateway", en: "Extra Payment Gateway" }, price: 85 }
    ],
    ...
    "custom-eshop": [
        ...
        { key: "languages", type: "stepper", label: { el: "Αριθμός Γλωσσών", en: "Number of Languages" }, min: 1, max: 5, default: 1, baseline: 1, pricePerUnit: 420 },
        { key: "erp", type: "toggle", label: { el: "Σύνδεση ERP / CRM", en: "ERP / CRM Integration" }, price: 645 }
    ],
    ...
    "full-ecommerce": [
        ...
        { key: "languages", type: "stepper", label: { el: "Αριθμός Γλωσσών", en: "Number of Languages" }, min: 1, max: 5, default: 1, baseline: 1, pricePerUnit: 480 },
        { key: "erp", type: "toggle", label: { el: "Σύνδεση ERP / CRM", en: "ERP / CRM Integration" }, price: 755 },
        { key: "customgraphics", type: "toggle", label: { el: "Custom Illustrations", en: "Custom Illustrations" }, price: 375 }
    ],
    ...
    "meta-ads-setup": [
        ...
        { key: "videoCreative", type: "toggle", label: { el: "Custom Video Creative αντί Static", en: "Custom Video Creative instead of Static" }, price: 105 }
    ],
    ...
    "content-population": [
        ...
        { key: "translation", type: "toggle", label: { el: "Μετάφραση Περιεχομένου", en: "Content Translation" }, price: 160 }
    ],
